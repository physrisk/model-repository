...
function populateField() {
    var i, j;
    field=new Array();
    var prob=myParseFloat($("#prob").val())/100.0;
    for(i=0;i<fieldL;i+=1) {
...
$("#plotDiv").click(function (e) {
    ...
    var posX=Math.floor((e.pageY-$(this).offset().top)/10.0);
...
$("#controlDiv").click(function (e) {
    ...
    var posY=Math.floor((e.pageY-$(this).offset().top)/10.0);
    if(posY==2) {
        posX-=2;
        if(posX%4==0) {
